...
The designer friendly 2D Canvas animation framework. *LIVE DEMO* => http://inmotion.jaeh.net
...
3. Implement all InMotion core methods
4. Support a image(by url) as 'skin' to the bones
