...
function InMotion(canvas_id){
	...
	// ex: 'preview' : { 'state' : 'playing'|'stop', 'time': Date }
	this.animations = {}
	...
	function step( clear ) {
		...
		// All the drawing to perform, defined by a Tween
		var draw = []
		
		var animated = false;
		instance.animations.each( function(id, anim){ //Each animation regitered
...
j('#console').html(bone_id+" "+i+" "+elapse +"  "+state.duration )
