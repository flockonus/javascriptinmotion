...
h = {
   '103378sb' : [{p1x:-49, p1y:-69, p2x:139, p2y:49, shape:'linear', animation: 'default', duration:0.5}]
}
...
function Editor(){
	...
	this.im = new InMotion('drawingtable')
	...
	function set_mode(state){
		switch(state){
			...
			case 'preview0' :
				...
				instance.im.import( 'base', instance.export() );
				instance.preview_routine = setInterval('$e.loop_preview()', 100 ); 
	...
	this.kf = kf
	this.loop_preview = loop_preview //Gambiarra?
}
